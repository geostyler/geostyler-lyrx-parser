...
import {MarkerPlacement, Options, Symbolizer, SymbolReference} from "./badTypes.ts";
import {processSymbolLayer} from "./processSymbolLayer.ts";

export const processSymbolReference = (symbolref: SymbolReference, options: Options): Symbolizer[] => {
