...
export const ptToPxProp = (obj: {
    [key: string]: any
}, prop: string, defaultValue: number, asFloat: boolean = true): number => {
...
export const extractStroke = (symbolLayers: any[]): [string, number, number] => {
